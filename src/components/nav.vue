        ...
        <div class="flex">
          <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
            ...
            <a href="/create-promotion"
               :class="`${isCreatePromotion ? 'border-indigo-500 text-gray-900 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium' } `">
              Créer une promotions
            </a>
            ...
            <a href="/create-article"
               :class="`${isCreateArticle ? 'border-indigo-500 text-gray-900 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium' } `">
              Créer un article
            </a>
          </div>
        </div>
